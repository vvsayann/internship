...
OUT_DIR = os.path.join(SPECTRA_FOLDER, "r060_voigt_results")
MIN_R2 = 0.60
...
def main():
    ...
    fitter = LineFitter(verbose=False)
    processor = SpectrumProcessor(LINE_CATALOG, fitter=fitter, plotter=plotter, min_r2=MIN_R2)
