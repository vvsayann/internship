...
class FitResult:
    ...
    fit_type: str = "none"        # "lorentzian"
    center: float = np.nan
    depth: float = np.nan
    width: float = np.nan         # gamma (Lorentzian half-width at half-maximum)
...
class LineFitter:
    """Fits a Lorentzian model to a windowed region around each catalog line."""
