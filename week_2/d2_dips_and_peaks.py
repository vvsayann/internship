...
from src.internship.utilities import raw_gaussian, blended_model, detect_features, fit_continuum, match_lines
...
FITS_PATH = r"C:\Users\Ayank\OneDrive\Desktop\internship\Week 2\spec-0375-52140-0345.fits"
...
if __name__ == "__main__":
    ...
    axes[1].axhline(-4, color="purple", ls="-", lw=1, label="y = -4")
    axes[1].axhline(-2, color="Yellow", ls="-", lw=1, label="y = -2")
